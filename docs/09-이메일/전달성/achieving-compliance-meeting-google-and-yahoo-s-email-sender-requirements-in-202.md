...
브랜디드 발송 서브도메인을 활성화한 후에는 향후 2-4주 동안 [발송 인프라의 점진적인 워밍업](email-sending-guide-email-best-practices-email-warm-up.md)이 필요할 수 있다는 점을 유념하세요.

도움이 필요하신가요? [브랜디드 발송 서브도메인 설정 가이드](dedicated-email-sending-domains-overview-setup.md)를 확인해보세요.
