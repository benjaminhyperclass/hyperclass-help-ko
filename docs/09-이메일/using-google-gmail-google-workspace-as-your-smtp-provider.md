...
* [2단계 인증이 활성화된 계정의 앱별 비밀번호 생성](using-google-gmail-google-workspace-as-your-smtp-provider.md#2단계-인증이-활성화된-계정의-앱별-비밀번호-생성)
* [2단계 인증 활성화 방법](using-google-gmail-google-workspace-as-your-smtp-provider.md#2단계-인증-활성화-방법)
* [자주 묻는 질문](using-google-gmail-google-workspace-as-your-smtp-provider.md#자주-묻는-질문)
...
[무료 이메일 주소를 SMTP로 사용할 수 없는 이유](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/09-%EC%9D%B4%EB%A9%94%EC%9D%BC/%EB%A7%81%ED%81%AC/README.md)를 확인하세요.

1. [Google.com](https://google.com)으로 이동
...
A. 특정 로케이션(하위 계정)에서 Gmail SMTP를 연동하려면 해당 하위 계정 검색 B. 에이전시의 모든 로케이션에서 Gmail SMTP를 연동하려면 Agency View로 전환

https://app.hyperclass.ai/settings/email\_services
...
_원문 최종 수정: 2026-03-06_ _Hyperclass 사용 가이드 — hyperclass.ai_
