...
* [도메인이란?](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#도메인이란)
* [루트 도메인과 서브 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#루트-도메인과-서브-도메인)
* [Domain Connect로 도메인 간편하게 연결하기](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#domain-connect로-도메인-간편하게-연결하기)
* [수동 설정](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#수동-설정)
* [Hyperclass에서 도메인을 추가할 수 있는 곳들](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#hyperclass에서-도메인을-추가할-수-있는-곳들)
* [화이트라벨 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#화이트라벨-도메인)
* [API 또는 브랜드 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#api-또는-브랜드-도메인)
* [사이트 (설정 > 도메인)](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#사이트-설정-도메인)
...
* [워드프레스](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#워드프레스)
* [도메인 용어집 - 알아두어야 할 핵심 단어들](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#도메인-용어집-알아두어야-할-핵심-단어들)
* [문제 해결](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#문제-해결)
* [자주 묻는 질문](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#자주-묻는-질문)
...
_경로: Agency View(에이전시 뷰) > Settings(설정) > Company Settings(회사 설정) > Whitelabel Domain(화이트라벨 도메인)_
...
_경로: Agency View(에이전시 뷰) > Settings(설정) > Company Settings(회사 설정) > API Domain(API 도메인)_
...
_경로: Sub-Account(하위 계정) > Settings(설정) > Business Profile(비즈니스 프로필) > API Domain(API 도메인)_

API/브랜드 도메인 설정에 대한 자세한 정보는 [브랜드 시스템 생성 링크 설정 방법](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/19-%EC%97%90%EC%9D%B4%EC%A0%84%EC%8B%9C-%EB%B7%B0/%EA%B8%B0%ED%83%80/how-to-configure-brand-system-generated-links-api-domain-.md)을 참조하세요.
...
| 용어                           | 예시                                                                                                                                                                       | 설명                                                                                                          |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------- |
| Domain(도메인)                  | www.Hyperclass.com                                                                                                                                                       | 웹사이트, 이메일 호스팅 등 온라인 서비스의 디지털 주소                                                                             |
| Root Domain(루트 도메인)          | Hyperclass.com                                                                                                                                                           | URL에서 "www." 뒤에 나타나는 웹사이트의 주요 주소 (예: "www.Hyperclass.com"에서 루트 도메인은 "Hyperclass.com"). 웹사이트의 메인 진입점 역할      |
| Subdomain(서브 도메인)            | help.Hyperclass.com                                                                                                                                                      | 루트 도메인의 확장으로, 온라인 인프라의 특정 섹션이나 영역으로 사용자를 안내 (예: 지원용 "help.domain.com")                                      |
| Hostname(호스트명)               | ![호스트명 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095813/original/_yK4XozIWht9RuVCgkZPZLj2RS-PgXlVxA.png?1717515282)      | 레코드에서 사용되는 이름/값으로, 일반적으로 사용되는 서브 도메인. 이를 통해 "help.Hyperclass.com" 같은 서브 도메인이 "www.Hyperclass.com"과 독립적으로 작동 |
