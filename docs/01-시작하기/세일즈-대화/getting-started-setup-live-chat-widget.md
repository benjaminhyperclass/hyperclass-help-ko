...
* [실시간 채팅 위젯 생성](getting-started-setup-live-chat-widget.md#실시간-채팅-위젯-생성)
* [임베드 코드로 실시간 채팅 위젯 배포](getting-started-setup-live-chat-widget.md#임베드-코드로-실시간-채팅-위젯-배포)
* [설정을 통해 실시간 채팅 위젯 배포](getting-started-setup-live-chat-widget.md#설정을-통해-실시간-채팅-위젯-배포)
...
* [하이레벨 채팅 위젯 설치 방법](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/06-%EC%82%AC%EC%9D%B4%ED%8A%B8/how-to-install-highlevel-s-chat-widget.md)
...
_원문 최종 수정: 2025년 5월 20일_ _Hyperclass 사용 가이드 — hyperclass.ai_
