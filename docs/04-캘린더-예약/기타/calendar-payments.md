...
- 그다음 GHL의 Payments(결제) 모듈 > Integrations(연동)으로 가서 Square Live Mode의 Connect(연결) 버튼을 클릭하세요. 로그인된 계정이 자동으로 선택되어 GHL과 연결됩니다!

**Razorpay** - [도움말 문서](how-to-integrate-razorpay-within-the-crm.md)
