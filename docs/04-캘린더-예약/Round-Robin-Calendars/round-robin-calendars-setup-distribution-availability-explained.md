...
* [라운드 로빈 캘린더란? 어떻게 작동하나요?](round-robin-calendars-setup-distribution-availability-explained.md#라운드-로빈-캘린더란-어떻게-작동하나요)
* [라운드 로빈 캘린더를 왜 사용하나요?](round-robin-calendars-setup-distribution-availability-explained.md#라운드-로빈-캘린더를-왜-사용하나요)
* [라운드 로빈 캘린더 만들기](round-robin-calendars-setup-distribution-availability-explained.md#라운드-로빈-캘린더-만들기)
* [하이퍼클래스 캘린더 추가 자료 및 지원](round-robin-calendars-setup-distribution-availability-explained.md#하이퍼클래스-캘린더-추가-자료-및-지원)
* [자주 묻는 질문](round-robin-calendars-setup-distribution-availability-explained.md#자주-묻는-질문)
...
* [HTML 코드를 사용하여 하이퍼클래스 캘린더 삽입하기](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/04-%EC%BA%98%EB%A6%B0%EB%8D%94-%EC%98%88%EC%95%BD/embedding-highlevel-calendars-using-html-code.md) – 더 쉬운 예약 접근을 위해 웹사이트나 랜딩 페이지에 캘린더를 공유하고 삽입하세요.

***

## 자주 묻는 질문

**Q. 예약 가능한 팀원이 없으면 어떻게 되나요?** 초대받는 사람에게 다른 날짜/시간을 선택하라는 안내가 표시됩니다.

**Q. 라운드 로빈을 사용하는 대신 수동으로 팀원에게 예약을 배정할 수 있나요?** 네, 예약 설정에서 자동 배정을 재정의할 수 있습니다.

**Q. 특정 고객에 대해 특정 팀원을 우선시할 수 있나요?** 아니요, 라운드 로빈은 현재 **예약 가능 여부 기반 또는 균등 배분 설정**만 지원합니다.

**Q. 고객이 예약할 때 요금을 청구할 수 있나요?** 네, \*\*Accept Payments(결제 수신)\*\*를 활성화하여 고객이 서비스를 예약할 때 결제를 요구할 수 있습니다.

***

_원문 최종 수정: 2026-03-16_ _Hyperclass 사용 가이드 — hyperclass.ai_
