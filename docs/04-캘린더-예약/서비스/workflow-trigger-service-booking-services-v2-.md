...
* [서비스 예약 트리거란?](workflow-trigger-service-booking-services-v2-.md#서비스-예약-트리거란)
* [서비스 예약 트리거의 주요 장점](workflow-trigger-service-booking-services-v2-.md#서비스-예약-트리거의-주요-장점)
* [언제 트리거되나요?](workflow-trigger-service-booking-services-v2-.md#언제-트리거되나요)
* [예약 상태 트리거와의 주요 차이점](workflow-trigger-service-booking-services-v2-.md#예약-상태-트리거와의-주요-차이점)
* [사용 가능한 필터](workflow-trigger-service-booking-services-v2-.md#사용-가능한-필터)
* [트리거 표시](workflow-trigger-service-booking-services-v2-.md#트리거-표시)
* [서비스 예약 시 주문 제출 트리거 동작](workflow-trigger-service-booking-services-v2-.md#서비스-예약-시-주문-제출-트리거-동작)
* [지원되는 예약 액션](workflow-trigger-service-booking-services-v2-.md#지원되는-예약-액션)
* [서비스 예약에서 커스텀 값 사용하기](workflow-trigger-service-booking-services-v2-.md#서비스-예약에서-커스텀-값-사용하기)
* [커스터마이징 방법](workflow-trigger-service-booking-services-v2-.md#커스터마이징-방법)
* [서비스 예약 워크플로우 트리거 설정 방법](workflow-trigger-service-booking-services-v2-.md#서비스-예약-워크플로우-트리거-설정-방법)
* [자주 묻는 질문](workflow-trigger-service-booking-services-v2-.md#자주-묻는-질문)
...
커스텀 값에 대한 더 자세한 정보를 원하시나요? [커스텀 값 사용 방법](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/23-%EB%A0%88%EA%B1%B0%EC%8B%9C-%EC%9E%90%EB%8F%99%ED%99%94/Logic-&-Fulfillment/how-to-use-custom-values.md)을 확인하세요.
...
* 필요한 필터를 사용하여 트리거를 요구사항에 맞게 구성합니다. [사용 가능한 필터에 대한 자세한 정보는 여기를 클릭하세요.](workflow-trigger-service-booking-services-v2-.md#사용-가능한-필터)
...
**Q: 하위 계정에서 서비스 예약 트리거를 사용할 수 있게 하려면 어떻게 해야 하나요?** 서비스(v2)가 활성화되어 있는지 확인하세요. 서비스가 비활성화되어 있으면 새 워크플로우에서 트리거를 사용할 수 없습니다. [서비스 활성화에 대한 자세한 정보는 여기를 클릭하세요](../services-overview-how-to-get-started.md)

**Q: 확인 메시지나 리마인더에 직원 세부 정보를 포함할 수 있나요?** 네. 커스텀 값을 사용하여 배정된 직원(또는 가격, 날짜, 위치 등의 기타 정보)을 커뮤니케이션에서 참조할 수 있습니다.

***

_원문 최종 수정: Tue, 18 Nov, 2025 at 9:03 AM_ _Hyperclass 사용 가이드 — hyperclass.ai_
