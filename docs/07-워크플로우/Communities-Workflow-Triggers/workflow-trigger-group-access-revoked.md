...
GoHighLevel 워크플로우의 그룹 액세스 취소됨(Group Access Revoked) 트리거는 커뮤니티 내 그룹 접근 권한 관리 프로세스를 자동화하여, 필요 시 접근 권한을 취소하고 커뮤니티 상호작용을 원활하게 관리할 수 있게 해줍니다.
...
- **워크플로우 빌더(Workflow Builder)로 이동**: GoHighLevel 계정에서 워크플로우 빌더에 접근합니다.
