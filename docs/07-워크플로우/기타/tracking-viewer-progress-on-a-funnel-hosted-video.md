...
이제 퍼널(Funnel)과 웹사이트(Website) 방문자의 동영상 시청 진행률을 추적하고, 설정한 완료율(%)에 따라 워크플로우(Workflow)를 트리거(Trigger)할 수 있습니다.

#### 이 가이드에서 다루는 내용:

#### [워크플로우를 통한 진행률 추적을 위해 동영상을 준비하는 방법](#워크플로우를-통한-진행률-추적을-위해-동영상을-준비하는-방법)
...
## 동영상 추적 워크플로우를 설정하는 방법

중요 참고사항:

동영상 추적의 정확도는 진행률 표시줄을 꺼두었는지 여부에 따라 달라집니다. 진행률 표시줄을 켜두면 워크플로우의 동영상 추적 정확도에 영향을 줄 수 있습니다.

---
*원문 최종 수정: Mon, 5 Feb, 2024 at 8:33 AM*
