---
원문: >-
  https://hyperclass.gitbook.io/hyperclass-docs/support/solutions/articles/155000005812-notion-integration-with-highlevel
...
* [하이퍼클래스와 Notion 연동이란?](notion-integration-with-highlevel.md#What-is-Notion-Integration-with-하이퍼클래스?)
* [Notion 연동의 주요 장점](notion-integration-with-highlevel.md#Key-Benefits-of-Notion-Integration)
* [트리거: Notion → 하이퍼클래스](notion-integration-with-highlevel.md#Triggers:-Triggers-\(Notion-→-하이퍼클래스\))
* [액션: 하이퍼클래스 → Notion](notion-integration-with-highlevel.md#Actions-\(하이퍼클래스-→-Notion\))
* [Notion 연동 시작하기](notion-integration-with-highlevel.md#Getting-Started-with-Notion)
* [Notion 트리거 작동 방식](notion-integration-with-highlevel.md#How-Notion-Triggers-Work)
* [활용 사례 1: 폼 제출로 Notion 문서 생성하기](notion-integration-with-highlevel.md#Use-Case-1:-Create-Notion-Docs-from-Form-Submissions)
* [활용 사례 2: 예약 결과를 Notion 로그와 동기화하기](notion-integration-with-highlevel.md#Use-Case-2:-Sync-Appointment-Outcomes-to-Notion-Logs)
* [활용 사례 3: 제안서 페이지 자동 생성하기](notion-integration-with-highlevel.md#Use-Case-3:-Auto-Generate-Proposal-Pages)
* [자주 묻는 질문](notion-integration-with-highlevel.md#Frequently-Asked-Questions)
...
**Q: 이 연동 기능을 사용하려면 Notion 유료 요금제가 필요한가요?** 아니요, 이 연동 기능은 Notion 무료 요금제에서도 작동해요. 다만 팀스페이스(Teamspace)나 분석 기능처럼 일부 기능은 유료 구독이 필요할 수 있어요.

**Q: Notion과 연결된 워크플로우 개수에 제한이 있나요?** 워크플로우 개수 제한은 가입하신 하이퍼클래스 요금제에 따라 달라져요. 또한 이 연동 기능은 Notion 공식 API의 요청 제한(Rate Limit)도 함께 적용받아요.

**Q: 하이퍼클래스는 얼마나 자주 Notion의 트리거 업데이트를 확인하나요?** 5분마다 확인해요.

**Q: 네이티브 연동으로 전환하면 기존 웹훅(Webhook)이 작동을 멈추나요?** 아니요. 마이그레이션(전환)하는 동안 웹훅과 네이티브 연동 기능을 동시에 함께 사용할 수 있어요.

***

_원문 최종 수정: 2025년 10월 21일_ _Hyperclass 사용 가이드 — hyperclass.ai_
