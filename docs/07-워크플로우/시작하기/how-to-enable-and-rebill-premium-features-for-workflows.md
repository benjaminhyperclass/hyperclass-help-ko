...
* [프리미엄 기능이란?](how-to-enable-and-rebill-premium-features-for-workflows.md#프리미엄-기능이란)
* [작동 원리](how-to-enable-and-rebill-premium-features-for-workflows.md#작동-원리)
* [새로운 프리미엄 트리거](how-to-enable-and-rebill-premium-features-for-workflows.md#새로운-프리미엄-트리거)
* [새로운 프리미엄 액션](how-to-enable-and-rebill-premium-features-for-workflows.md#새로운-프리미엄-액션)
  * [Google Sheets](how-to-enable-and-rebill-premium-features-for-workflows.md#google-sheets)
  * [Slack 알림](how-to-enable-and-rebill-premium-features-for-workflows.md#slack-알림)
  * [커스텀 아웃바운드 웹훅](how-to-enable-and-rebill-premium-features-for-workflows.md#커스텀-아웃바운드-웹훅)
  * [워크플로우 AI 액션](how-to-enable-and-rebill-premium-features-for-workflows.md#워크플로우-ai-액션)
* [에이전시 레벨에서 프리미엄 기능 활성화하기](how-to-enable-and-rebill-premium-features-for-workflows.md#에이전시-레벨에서-프리미엄-기능-활성화하기)
* [프리미엄 기능 요금](how-to-enable-and-rebill-premium-features-for-workflows.md#프리미엄-기능-요금)
* [고객에게 비용 재청구하여 수익 창출하기](how-to-enable-and-rebill-premium-features-for-workflows.md#고객에게-비용-재청구하여-수익-창출하기)
* [화이트라벨 고객 안내 자료](how-to-enable-and-rebill-premium-features-for-workflows.md#화이트라벨-고객-안내-자료)
...
Google Sheets 프리미엄 워크플로우 액션은 Google Sheets 문서 내에서 다양한 데이터 관리 작업을 자동화할 수 있는 강력한 도구입니다. 이 기능을 사용하면 복잡한 서드파티 통합 없이도 스프레드시트에서 행을 생성, 업데이트, 삭제, 조회할 수 있습니다. 자세한 내용과 사용 사례는 [이 도움말](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/07-%EC%9B%8C%ED%81%AC%ED%94%8C%EB%A1%9C%EC%9A%B0/%EA%B8%B0%ED%83%80/how-to-use-the-google-sheets-premium-workflow-action-.md)을 참조하세요.
...
* 에이전시는 Hyperclass에 결제하고 Hyperclass 브랜딩의 인보이스를 받습니다
...
* [Google Sheets 액션](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/07-%EC%9B%8C%ED%81%AC%ED%94%8C%EB%A1%9C%EC%9A%B0/%EA%B8%B0%ED%83%80/how-to-use-the-google-sheets-premium-workflow-action-.md)
...
_원문 최종 수정: Thu, 7 Aug, 2025 at 8:11 AM_ _Hyperclass 사용 가이드 — hyperclass.ai_
