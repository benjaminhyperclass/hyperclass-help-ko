...
온보딩에 도움이 필요하신가요? [WhatsApp 로케이션 온보딩 단계 및 모범 사례](how-to-use-the-whatsapp-business-onboarding-checklist.md)를 참조하여 프로세스를 완료하세요.
...
WhatsApp의 최신 업데이트로 미디어 템플릿이 지원되어, 이미지, 비디오, 문서, 위치 등 다양한 미디어 콘텐츠를 보낼 수 있습니다. 자세한 내용: [WhatsApp 미디어 템플릿]([whatsapp-media-templates](whatsapp-media-templates.md))
