...
* [라디오 버튼 & 체크박스 요소의 버블 스타일이란?](bubble-style-for-radio-checkbox-elements.md#라디오-버튼-체크박스-요소의-버블-스타일이란)
* [버블 스타일의 주요 장점](bubble-style-for-radio-checkbox-elements.md#버블-스타일의-주요-장점)
* [반응형 동작](bubble-style-for-radio-checkbox-elements.md#반응형-동작)
* [호환성 및 제한사항](bubble-style-for-radio-checkbox-elements.md#호환성-및-제한사항)
* [버블 스타일 설정 방법](bubble-style-for-radio-checkbox-elements.md#버블-스타일-설정-방법)
* [자주 묻는 질문](bubble-style-for-radio-checkbox-elements.md#자주-묻는-질문)
...
* 폼 & 설문에서 "기타" 옵션 사용 가능
* [하이퍼클래스에서 연락처 폼 만드는 방법](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/02-%EC%97%B0%EB%9D%BD%EC%B2%98/%EA%B8%B0%ED%83%80/how-to-create-a-contact-form-in-highlevel-.md)
* 폼 빌더를 사용하여 퍼널 내 폼 커스터마이징

***

_원문 최종 수정: 2025년 10월 14일_ _Hyperclass 사용 가이드 — hyperclass.ai_
