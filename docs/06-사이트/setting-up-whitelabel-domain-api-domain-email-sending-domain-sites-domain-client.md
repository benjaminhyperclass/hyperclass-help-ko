...
* [도메인이란 무엇인가요?](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#도메인이란-무엇인가요)
* [루트 도메인과 서브 도메인이란?](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#루트-도메인과-서브-도메인이란)
* [Domain Connect로 손쉽게 도메인 연결하기](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#domain-connect로-손쉽게-도메인-연결하기)
* [수동 옵션](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#수동-옵션)
* [Hyperclass에서 도메인을 추가할 수 있는 곳](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#hyperclass에서-도메인을-추가할-수-있는-곳)
* [화이트라벨 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#화이트라벨-도메인)
* [API 또는 브랜딩 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#api-또는-브랜딩-도메인)
* [사이트 (Settings > Domains)](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#사이트-settings-domains)
* [이메일 발송 도메인](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#이메일-발송-도메인)
* [클라이언트 포털 도메인 (커뮤니티, 강의)](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#클라이언트-포털-도메인-커뮤니티-강의)
* [WordPress](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#wordpress)
* [도메인 용어집 - 알아야 할 핵심 용어](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#도메인-용어집-알아야-할-핵심-용어)
* [문제 해결](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#문제-해결)
* [FAQ](setting-up-whitelabel-domain-api-domain-email-sending-domain-sites-domain-client.md#faq)
...
도메인을 손쉽게 연결하는 방법에 대한 자세한 정보는 [Domain Connect 기능 사용 방법](../42-통합/기타/how-to-use-the-domain-connect-feature-.md)을 참조하세요.
...
이 수동 과정에 대해 더 자세히 알아보려면 [여기](how-to-set-up-root-domain-subdomain-for-your-funnels-websites-.md)를 참조하세요.
...
_Agency View(에이전시 뷰) > Settings(설정) > Company Settings(회사 설정) > Whitelabel Domain(화이트라벨 도메인)으로 이동_
...
_Agency View(에이전시 뷰) > Settings(설정) > Company Settings(회사 설정) > API Domain(API 도메인)으로 이동_
...
_Sub-Account(하위 계정) > Settings(설정) > Business Profile(비즈니스 프로필) > API Domain(API 도메인)으로 이동_

API/브랜딩 도메인 설정에 대한 자세한 정보는 [브랜드 시스템 생성 링크 구성 방법](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/19-%EC%97%90%EC%9D%B4%EC%A0%84%EC%8B%9C-%EB%B7%B0/%EA%B8%B0%ED%83%80/how-to-configure-brand-system-generated-links-api-domain-.md)을 참조하세요.
...
_Sub-Account(하위 계정) > Settings(설정) > Domains(도메인)으로 이동_

웹사이트에 도메인을 추가하는 방법에 대한 자세한 정보는 [퍼널/웹사이트용 루트/서브 도메인 설정 방법](how-to-set-up-root-domain-subdomain-for-your-funnels-websites-.md)을 참조하세요.
...
전용 이메일 발송 도메인 설정 과정에 대한 자세한 정보는 [전용 발송 도메인 설정 방법](../09-이메일/기타/how-to-set-up-a-dedicated-sending-domain-lc-email-.md)을 참조하세요.
...
_Sub-Account(하위 계정) > Sites(사이트) > ClientPortal(클라이언트포털) > API Domain(API 도메인)으로 이동_

클라이언트 포털 설정에 대한 자세한 정보는 [클라이언트 포털 설정 방법](../36-기타/리커버리/how-to-set-up-the-client-portal.md)을 참조하세요.
...
_Sub-Account(하위 계정) > Sites(사이트) > Wordpress > Add Domain(도메인 추가)로 이동_

WordPress 도메인 설정에 대한 자세한 정보는 [WordPress 클라이언트 측 설정 가이드 시작하기](../36-기타/리커버리/getting-started-with-wordpress-client-side-setup-guide.md)를 참조하세요.
...
| 예시                               | 설명                                                                                                                                                                       |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **도메인**                          | www.Hyperclass.com                                                                                                                                                       |
| **루트 도메인**                       | Hyperclass.com                                                                                                                                                           |
| **서브 도메인**                       | help.Hyperclass.com                                                                                                                                                      |
| **Hostname**                     | ![호스트명 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095813/original/_yK4XozIWht9RuVCgkZPZLj2RS-PgXlVxA.png?1717515282)      |
| **Data/Target/Value**            | ![데이터 값 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095812/original/vLgs8iDxu5UEvVPjhHmwDc0COPb0G20twQ.png?1717515282)     |
| **Nameservers**                  | GoDaddy, Cloudflare, Google 등                                                                                                                                            |
| **DNS (Dedicated Name Servers)** | ![DNS 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095815/original/OK0coxwyfKCwvT4GTuhBhFWJm35KSh-OuA.png?1717515282)       |
| **TXT**                          | ![TXT 레코드 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095810/original/XgKktnkym29TrLhZdbDE9ZUxHWtMd3m0OQ.png?1717515282)   |
| **MX**                           | ![MX 레코드 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095814/original/3rDvCDQP1_qG-XwtVojf_EOOmjQXYj39bA.png?1717515282)    |
| **CNAME**                        | ![CNAME 레코드 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095811/original/8cdtZ17kqkLPdZnKQMkBwVtW08YLYykVPg.png?1717515282) |
| **A Record**                     | ![A 레코드 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095818/original/Euay6ddSoczuJvgIyaQABt4wvVqK5JNtKA.png?1717515282)     |
| **DMARC**                        | ![DMARC 레코드 예시](https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/155027095820/original/vBdK9jdlUVOa9fmp-DSBENEfTwdHxgN5zQ.png?1717515282) |
