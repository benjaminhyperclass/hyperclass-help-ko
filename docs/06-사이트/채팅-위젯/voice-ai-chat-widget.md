...
**중요**: 이 기능은 현재 Labs에서 제공되며, 에이전시가 하위 계정(Sub-account)에 대해 활성화해야 합니다. 자세한 내용은 [Labs 기능 - 전체 개요](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/19-%EC%97%90%EC%9D%B4%EC%A0%84%EC%8B%9C-%EB%B7%B0/Agency-Settings/labs-features-complete-overview.md)를 참조하세요.

***

**목차**

* [음성 AI 채팅 위젯이란?](voice-ai-chat-widget.md#음성-ai-채팅-위젯이란)
* [음성 위젯의 주요 장점](voice-ai-chat-widget.md#음성-위젯의-주요-장점)
* [음성 전용 채팅 타입](voice-ai-chat-widget.md#음성-전용-채팅-타입)
* [AI 에이전트 이름 변경하는 방법](voice-ai-chat-widget.md#ai-에이전트-이름-변경하는-방법)
* [내장된 통화 녹음 안내](voice-ai-chat-widget.md#내장된-통화-녹음-안내)
* [reCAPTCHA 보호 기능](voice-ai-chat-widget.md#recaptcha-보호-기능)
* [브라우저 기반 상호작용](voice-ai-chat-widget.md#브라우저-기반-상호작용)
* [동시 통화 제한](voice-ai-chat-widget.md#동시-통화-제한)
* [지원되는 기능](voice-ai-chat-widget.md#지원되는-기능)
* [음성 위젯 설정하는 방법](voice-ai-chat-widget.md#음성-위젯-설정하는-방법)
* [자주 묻는 질문](voice-ai-chat-widget.md#자주-묻는-질문)
...
서비스 상태 확인: [status.Hyperclass.com](http://status.hyperclass.ai)에서 진행 중인 장애를 확인하세요.
...
2. **코드 받기(Get Code)** 옵션을 찾아 제공된 코드를 복사합니다.
...
_원문 최종 수정: Tue, 13 Jan, 2026 at 3:18 PM_ _Hyperclass 사용 가이드 — hyperclass.ai_
