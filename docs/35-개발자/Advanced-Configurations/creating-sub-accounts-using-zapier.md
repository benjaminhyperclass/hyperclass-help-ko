...
Zapier 없이 Hyperclass 내에서 계정 생성을 자동화하고 싶다면 Hyperclass [SaaS 가이드](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/16-SaaS-%EC%84%A4%EC%A0%95/Saas-Mode/saas-mode-full-setup-guide-faq.md)를 확인해주세요 (Pro 플랜 필요).
...
[**1. 에이전시 설정에서 에이전시 API 키 가져오기**](creating-sub-accounts-using-zapier.md#1-에이전시-설정에서-에이전시-api-키-가져오기)

[**2. 에이전시 API 키를 복사한 후 Zapier에 로그인하여 새 Zap 만들기**](creating-sub-accounts-using-zapier.md#2-에이전시-api-키를-복사한-후-zapier에-로그인하여-새-zap-만들기)

[**3. Zapier로 돌아가서 로케이션 Zap 만들기**](creating-sub-accounts-using-zapier.md#3-zapier로-돌아가서-로케이션-zap-만들기)

[**4. Continue를 클릭하고 테스트 실행하기**](creating-sub-accounts-using-zapier.md#4-continue를-클릭하고-테스트-실행하기)

[**5. 마지막 단계로 사용자, 비밀번호를 만들고 새 로케이션에 추가하기**](creating-sub-accounts-using-zapier.md#5-마지막-단계로-사용자-비밀번호를-만들고-새-로케이션에-추가하기)

[**6. Continue를 클릭하고 테스트 실행하기**](creating-sub-accounts-using-zapier.md#6-continue를-클릭하고-테스트-실행하기)

[**문제 해결**](creating-sub-accounts-using-zapier.md#문제-해결)

[**Q1) 사용자 생성 시 Post 결과에서 비밀번호, 로케이션 또는 에이전시 API를 받지 못하는 경우**](creating-sub-accounts-using-zapier.md#q1-사용자-생성-시-post-결과에서-비밀번호-로케이션-또는-에이전시-api를-받지-못하는-경우)

[**Q2) 워크플로우에서 웹훅이 실행되지 않는 경우**](creating-sub-accounts-using-zapier.md#q2-워크플로우에서-웹훅이-실행되지-않는-경우)**-워크플로우에서-웹훅이-실행되지-않는-경우)**
...
* Own: [직접 생성한 스냅샷](https://github.com/benjaminhyperclass/hyperclass-help-ko/blob/main/docs/19-%EC%97%90%EC%9D%B4%EC%A0%84%EC%8B%9C-%EB%B7%B0/Snapshots/snapshots-overview.md)
...
_원문 최종 수정: Sun, 29 Dec, 2024 at 1:27 PM_ _Hyperclass 사용 가이드 — hyperclass.ai_
