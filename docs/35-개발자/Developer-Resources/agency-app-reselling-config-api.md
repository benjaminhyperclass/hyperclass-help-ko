...
아니요. 하위 계정 토큰을 사용해야 하며, 에이전시 토큰은 403 Forbidden을 받게 됩니다. ([marketplace.Hyperclass.com](https://marketplace.gohighlevel.com/docs/ghl/marketplace/get-rebilling-config-for-app/index.html))
