...
자세한 내용은 [관련 지원 문서](../기타/why-are-my-calls-marked-as-spam-and-how-can-i-avoid-it-lc-phone-.md)를 참조하세요.
...
b. 발신자 ID(예: 전화번호)와 설명적인 Caller ID Name (CNAM)을 연결하세요. 지침은 [CNAM을 사용한 통화 브랜딩](../기타/why-are-my-calls-marked-as-spam-and-how-can-i-avoid-it-lc-phone-.md)을 참조하세요.
