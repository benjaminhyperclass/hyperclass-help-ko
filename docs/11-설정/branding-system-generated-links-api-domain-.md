...
"**Add Domain**" 버튼을 클릭하면 [도메인 연결 마법사](how-to-use-the-domain-connect-feature-.md)가 실행됩니다. 안내에 따라 마법사가 도메인 등록업체에서 자동으로 **CNAME**을 생성하도록 합니다.
...
**Add Domain**을 클릭하여 [도메인 연결 마법사](how-to-use-the-domain-connect-feature-.md)를 실행합니다. 안내에 따라 도메인 등록업체에서 자동으로 CNAME 레코드를 생성합니다.
