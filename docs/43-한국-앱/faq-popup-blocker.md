...
![Chrome 팝업 차단 해제 — 주소창 차단 아이콘 클릭 후 항상 허용 선택](../../.gitbook/assets/chrome-pc.png)
...
![Edge 팝업 차단 해제 — 쿠키 및 사이트 권한에서 팝업 및 리디렉션 차단 토글 끄기](../../.gitbook/assets/edge-pc.png)
...
![맥 Safari 팝업 차단 해제 — 웹 사이트 탭의 팝업 윈도우에서 허용 선택](../../.gitbook/assets/safari-mac.png)
...
![아이폰 Safari 팝업 차단 해제 — 설정 앱에서 Safari의 팝업 차단 토글 끄기](../../.gitbook/assets/ios-safari.png)
...
![안드로이드 크롬 팝업 차단 해제 — 사이트 설정에서 팝업 및 리디렉션 허용](../../.gitbook/assets/android-chrome.png)
...
![삼성 인터넷 팝업 차단 해제 — 사이트 및 다운로드에서 팝업 차단 토글 끄기](../../.gitbook/assets/samsung-internet.png)
...
![카카오톡 인앱 브라우저 — 메뉴에서 다른 브라우저로 열기 선택](../../.gitbook/assets/kakao-inapp.png)
...
_본 안내는 2026년 8월 기준 각 브라우저의 메뉴 구성을 반영했습니다. 브라우저 업데이트에 따라 메뉴 이름·위치가 다소 달라질 수 있습니다._
