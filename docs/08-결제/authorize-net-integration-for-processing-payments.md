...
#### [Authorize.net에서 FDS 필터를 사용하여 주소나 카드 코드가 제출되지 않으면 검토를 위해 거래를 보류하고 있습니다. 시스템이 이런 경우를 처리할 수 있나요?](#authorizenet에서-fds-필터를-사용하여-주소나-카드-코드가-제출되지-않으면-검토를-위해-거래를-보류하고-있습니다-시스템이-이런-경우를-처리할-수-있나요)

#### [언제 Authorize.net이 인보이스/Text2Pay/캘린더 결제/멤버십 및 기타 영역에서 사용 가능하게 되나요?](#언제-authorizenet이-인보이스text2pay캘린더-결제멤버십-및-기타-영역에서-사용-가능하게-되나요)
