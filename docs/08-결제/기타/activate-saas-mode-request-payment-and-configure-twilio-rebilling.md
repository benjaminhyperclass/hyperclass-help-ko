...
이는 고객이 LC Phone을 사용하는 경우에만 작동합니다(Twilio 제외). [여기를 클릭](../../15-전화-시스템/how-do-i-migrate-my-agency-and-sub-account-over-to-lc-phone-.md)하여 계정을 LeadConnector Phone 시스템으로 이전하는 방법을 알아보세요.
...
[에이전시의 LC 커뮤니케이션 지출을 분석하는 방법은?](../../09-이메일/how-to-analyze-an-agency-s-spending-on-lc-communications.md)
