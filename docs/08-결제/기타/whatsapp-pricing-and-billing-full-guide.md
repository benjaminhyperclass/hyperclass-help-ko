...
왓츠앱 템플릿 생성 시 적절한 카테고리를 선택하는 방법을 알아보려면 [템플릿 분류 가이드라인](template-categorisation-guidelines.md)을 참조하세요.
...
[왓츠앱 메시지 및 재청구에 대한 더 자세한 설정 가이드는 여기를 클릭하세요!](whatsapp-full-setup-guide-for-agency.md)
...
[↗ 에이전시를 위한 왓츠앱 완전 설정 가이드](whatsapp-full-setup-guide-for-agency.md)
[↗ 왓츠앱 연락처 관리 및 스마트 리스트](whatsapp-contact-management-and-smartlist.md)
[↗ 왓츠앱: 메시지 템플릿(스니펫) 보내기](whatsapp-send-message-templates-snippets-.md)
[↗ 재청구, 재판매, 지갑 설명](rebilling-reselling-and-wallets-explained.md)
↗ 워크플로우 트리거: 클릭 투 왓츠앱 광고
[↗ 왓츠앱과 하위 계정 설정](how-to-set-up-whatsapp-for-a-sub-account.md)
