...
**중요**: Stripe는 현재 다음 국가에서 지원됩니다([https://stripe.com/in/global](https://stripe.com/in/global)). 더 많은 국가가 추가될 예정입니다. Stripe가 귀하의 국가에서 지원되면, 전 세계 고객에게 판매할 수 있습니다.
...
### **1단계:** 하위 계정 Stripe 연동에 접근하는 3가지 방법이 있습니다.

### 방법 1: 하위 계정 런치패드에서

- 하위 계정에서 **런치패드(Launchpad)**를 클릭하세요.

- 설정 가이드에서 **Ecommerce**를 선택하세요.

- **Start Collecting Payments with Stripe** 옵션을 클릭하세요.
