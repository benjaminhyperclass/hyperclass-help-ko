...
"**Add Domain(도메인 추가)**" 버튼을 클릭하면 [도메인 연결 마법사](how-to-use-the-domain-connect-feature-.md)가 실행됩니다. 안내에 따라 마법사가 도메인 등록기관에서 자동으로 **CNAME**을 생성하도록 합니다.
...
**Add Domain(도메인 추가)**를 클릭하여 [도메인 연결 마법사](how-to-use-the-domain-connect-feature-.md)를 실행합니다. 안내에 따라 도메인 등록기관에서 CNAME 레코드를 자동으로 생성합니다.
...
API 통합의 경우 [HighLevel의 API 문서](https://developers.gohighlevel.com/)를 참조하세요.
