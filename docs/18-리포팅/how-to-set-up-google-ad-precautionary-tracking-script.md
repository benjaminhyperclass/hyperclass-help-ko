...
[구글 광고 보조 추적 스크립트 설정하는 방법](how-to-set-up-google-ad-precautionary-tracking-script.md#구글-광고-보조-추적-스크립트-설정하는-방법)

[1단계: 구글 광고 계정에 접속하기](how-to-set-up-google-ad-precautionary-tracking-script.md#1단계-구글-광고-계정에-접속하기)

[2단계: 도구 및 설정 > 일괄 작업 > 스크립트 클릭하기 (아래 이미지 참조)](how-to-set-up-google-ad-precautionary-tracking-script.md#2단계-도구-및-설정-일괄-작업-스크립트-클릭하기-아래-이미지-참조)

[3단계: 기본 코드를 삭제하고 이 스크립트를 추가하기](how-to-set-up-google-ad-precautionary-tracking-script.md#3단계-기본-코드를-삭제하고-이-스크립트를-추가하기)

[**4단계:** 스크립트 이름을 변경하고 빈도를 시간별로 설정하기](how-to-set-up-google-ad-precautionary-tracking-script.md#4단계-스크립트-이름을-변경하고-빈도를-시간별로-설정하기)

[자주 묻는 질문](how-to-set-up-google-ad-precautionary-tracking-script.md#자주-묻는-질문)

* [다른 스크립트가 있으면 영향을 받나요?](how-to-set-up-google-ad-precautionary-tracking-script.md#다른-스크립트가-있으면-영향을-받나요)
* [왜 승인이 필요한가요?](how-to-set-up-google-ad-precautionary-tracking-script.md#왜-승인이-필요한가요)
...
_원문 최종 수정: Wed, 14 Sep, 2022 at 11:55 AM_ _Hyperclass 사용 가이드 — hyperclass.ai_
