...
Hyperclass API 문서는 **[https://marketplace.hyperclass.ai/docs/](https://marketplace.hyperclass.ai/docs/)**에서 확인하실 수 있습니다. 기존 Stoplight 문서를 사용하셨다면 북마크를 업데이트해주세요. Stoplight 문서는 향후 몇 개월 내에 중단될 예정입니다.

## Hyperclass API 도움말 및 지원 받는 방법

**중요**: 현재 Hyperclass 지원팀은 API 관련 주제에 대한 설정 코드 검토나 개발자 컨설팅 서비스를 제공하지 않습니다. 그러나 설정이 완료되고 올바른데도 오류가 지속된다면, 저희가 수정해야 할 API 버그를 발견했을 수 있습니다. 이 양식을 작성하여 버그를 신고할 수 있습니다: [https://developers.hyperclass.ai/support](https://developers.hyperclass.ai/support)

Hyperclass API와 관련된 모든 질문은 개발자 슬랙 그룹에 가입하여 재능 있는 고객 커뮤니티에 질문해보세요: [https://developers.hyperclass.ai/join-dev-community](https://developers.hyperclass.ai/join-dev-community)

**Hyperclass 개발팀은 매달 마지막 주 전 금요일에 Developer Council Call을 진행하며, 이벤트 캘린더에서 확인하실 수 있습니다: [https://hyperclass.ai/events](https://hyperclass.ai/events)**

개발자 마켓플레이스, 문서, 슬랙 채널 등을 찾을 수 있는 [개발자 랜딩 페이지](https://developers.hyperclass.ai/)를 확인해보세요: [https://developers.hyperclass.ai/](https://developers.hyperclass.ai/)
...
Hyperclass은 최적의 성능과 안정성을 보장하기 위해 OAuth를 사용하는 공용 V2 API에 속도 제한을 구현했습니다. 이러한 제한은 다음과 같이 조정되었습니다:
...
공식 API 문서는 Hyperclass Developer Marketplace에서 확인할 수 있습니다: [https://marketplace.hyperclass.ai/docs/](https://marketplace.hyperclass.ai/docs/?utm_source=chatgpt.com)
...
여기서 직접 버그를 신고하세요: [https://developers.hyperclass.ai/support](https://developers.hyperclass.ai/support)

**2. 개발자 커뮤니티**

다른 개발자와 협업하기 위해 Hyperclass Dev Slack에 가입하세요: [https://developers.hyperclass.ai/join-dev-community](https://developers.hyperclass.ai/join-dev-community)
